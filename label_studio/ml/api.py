...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        tags=['Machine Learning'],
        x_fern_sdk_group_name='ml',
        x_fern_sdk_method_name='force_train',
        x_fern_audiences=['public'],
        operation_summary='Force Train',
        operation_description="""
        Train the ML backend on a specific task ID. 
        ...
        manual_parameters=[
            ...
            openapi.Parameter(
                ...
                description='A unique integer value identifying the task.',
            ),
        ],
        request_body=openapi.Schema(
            type=openapi.TYPE_OBJECT,
        ...
        responses={
            200: openapi.Response(description='Training complete.'),
            500: openapi.Response(
                description='Training error',
                schema=openapi.Schema(
                    description='Error message',
...
class MLBackendForceTrainAPI(APIView):
